...
namespace ChessChallenge.Application
{
    public class BoardUI
    {
        ...
        BoardTheme theme;
        ConcurrentDictionary<int, Color> squareColOverrides;
        Board board;
        Move lastMove;
        ...
        public BoardUI()
        {
            ...
            squareColOverrides = new ConcurrentDictionary<int, Color>();
        ...
        public void OverrideSquareColour(int square, HighlightType hightlightType)
        {
            ...
            squareColOverrides.AddOrUpdate(square, col, (key, oldValue) => col);
        }
