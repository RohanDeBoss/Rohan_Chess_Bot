...
// Trustbot 1.8 - Knight Rim Penalty
// Added: Knight Rim Penalty (-0.1).
//        - Implemented by updating KnightCenterBonus array index 0 to -10.
// Previous: Rook Activity, Bishop Mobility, King Attack, Endgame King Logic.
public class MyBot : IChessBot
{
    ...
    // Positional Bonuses
    // Knight: Edge=-10, Ring1=+5, Ring2=+15, Center=+25
    private static readonly int[] KnightCenterBonus = { -10, 5, 15, 25 };
