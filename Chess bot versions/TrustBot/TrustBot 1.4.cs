...
// Trustbot 1.4 - HCE Accumulation
// Added: Bishop Mobility (+0.01 per legal move).
// Previous: King Attack (+0.2/0.3), Knight Centrality (+0.05..0.25), Endgame King Proximity.
public class MyBot : IChessBot
{
    ...
    private const int BISHOP_MOBILITY_BONUS = 1;    // +0.01 per legal move
    private static readonly int[] KnightCenterBonus = { 0, 5, 15, 25 }; // Edge -> Center
