...
// Trustbot 2.0 - King Safety Phase Check
// Logic: The King Castling Bonus (+0.25) is added to mgScore ONLY.
//        Due to Phase Tapering, this bonus naturally reaches 0 in the endgame,
//        allowing the King Centrality bonus (in egScore) to take priority.
// Includes: Rook Activity, Bishop Mobility, Knight Centrality, Endgame Proximity.
public class MyBot : IChessBot
{
    ...
    private static readonly int[] EG_PieceValues = { 100, 290, 305, 510, 950, 0 };
    ...
    // King Safety (MG Only)
    private const int KING_CASTLE_BONUS = 15;           // +0.25 for being on files A-C or G-H
    private const int KING_SAFETY_EXPOSURE_PENALTY = 1; // -0.01 per open pseudo-queen square

    // Rook HCE
    private const int ROOK_MOBILITY_MG = 1;
    private const int ROOK_MOBILITY_EG = 3;
    ...
    private const int DOUBLED_PAWN_PENALTY = -15;
    private const int ISOLATED_PAWN_PENALTY = -10;
