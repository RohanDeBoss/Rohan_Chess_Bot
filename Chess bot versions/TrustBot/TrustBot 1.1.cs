...
// Trustbot 1.1 - No Piece Square Tables + King Attack HCE
// Added: +0.2 eval if a piece/pawn attacks the enemy King's ring.
//        +0.1 extra if it attacks a 2nd square (max +0.3 per piece).
//        Our King is excluded from calculation.
