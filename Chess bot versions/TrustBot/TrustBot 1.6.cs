...
// Trustbot 1.6 - King Edge Logic
// Added: Endgame King Centrality.
//        - My King Center: Good (+0.3). Edge: Bad (+0.0).
//        - Enemy King Center: Bad for me. Edge: Good for me.
//        - Applies to Endgame score regardless of winning/losing.
// Retains: 1.5 Fix for Proximity (only approach if winning).
public class MyBot : IChessBot
{
    ...
    // Positional Bonuses (Edge -> Center)
    private static readonly int[] KnightCenterBonus = { 0, 5, 15, 25 };
    private static readonly int[] KingCenterBonus = { 0, 10, 20, 30 }; // +0.3 max for King in EG
    ...
    private int Evaluate(Board board)
    {
        ...
        {
            // Only approach if we have material advantage (Fixed 1.5 logic)
        ...
        // Black King Centrality (Subtract from EG score - making it lower if Black is central)
